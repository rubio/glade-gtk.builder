...
class LabelWindow(Gtk.Window):
    ...
    def __init__(self):
        super(LabelWindow, self).__init__(title="Label Example")

        hbox = Gtk.Box(spacing=18)
        ...
        label = Gtk.Label(
            "This is a rigth-jstified label\nWith multiple lines.")
        ...
        label = Gtk.Label("This is an example of a line-wrapped, filled label."
                          ...
                          "    This is a another newer, longer, better "
        ...
        label.set_markup("Text can be <small>small</small>, <big>big</big>, "
                         "<b>bold</b>, <i>italic</i> and event point to "
